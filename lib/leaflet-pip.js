...
var leafletPip = {
    ...
    pointInLayer: function(p, layer, first) {
        ...
        layer.eachLayer(function(l) {
			...
			{				
				geomType = ukData.features[layer_count].geometry;                 
				currentHoverOverGEOUNIT_CD = ukData.features[layer_count].properties.GEOUNIT_CD;
				currentHoverOverGEOUNIT_NM = ukData.features[layer_count].properties.GEOUNIT_NM;				
